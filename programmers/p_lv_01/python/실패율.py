...
def solution_001(N, stages):
    ...
    print([i[0] for i in sorted(answer, key=lambda x: (-x[1], x[0]))])
...
def solution_003(N, stages):
    ...
    print(sorted(fail, key=fail.get, reverse=True))
...
solution_001(N_001, stages_001)
solution_002(N_001, stages_001)
solution_003(N_001, stages_001)